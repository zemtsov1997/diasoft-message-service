...
public class VkHistory {
    ...
    public VkHistory(IVkTextMessage telegramTextMessage) {
        this.dateTime = LocalDateTime.now();
        this.recipient = telegramTextMessage.getUserId().toString();
        this.message = telegramTextMessage.getMessage();
    }

    public VkHistory(LocalDateTime dateTime, String recipient, String message) {
